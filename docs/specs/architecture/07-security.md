...
| Brute-force defence  | Keycloak realm-level brute-force protection on `xitter-demo` (`brute_force_protected`, temporary lockout only — Keycloak's default ramp) — the login defence now that the realm is globally reachable; repeated failed logins temporarily lock the account.                                                                                                                                                                                                                                                                                                                             |
