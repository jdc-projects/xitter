...
| cms Postgres                | Truncate Payload _content_ tables only (About sections, FAQ); admin users/sessions are re-established, not lost                                                                                                                    | CMS content reset via Payload's own REST API + re-apply from repo seed files                                                                             |
