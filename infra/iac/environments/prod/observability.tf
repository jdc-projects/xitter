  ...
  manifest = {
    ...
    spec = {
      groups = [
        ...
        {
          # Edge signals, from the homelab edge's own metrics: 5xx rate on
          # xitter routes. Cert expiry used to be alerted here as well; it
          # moved to the homelab's own traefik-tls-cert-expiry rule
